...
const BMVVehicleHeader: React.FC = () => {
            ...
            <Row className="second_main_row" align="middle" justify='space-between' >
                ...
                <Col style={{ paddingRight: '2em' }}>
                    <span className='sort_items'>
                        ...
                        <li className='other_child'>Submitted Date</li>
                        <li className='other_child'>Location</li>
                        <li className='other_child'>Accepted Date</li>
                        <li className='other_child'>Completed Date</li>
                    </span>
...
export default BMVVehicleHeader;
